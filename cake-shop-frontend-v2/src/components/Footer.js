      ...
      <div className="container">
        <div className="row g-4 justify-content-center text-center">
          <div className="col-md-4 d-flex flex-column align-items-center text-center">
            <div className="d-flex align-items-center gap-2 mb-3 justify-content-center">
              ...
              >
                <i
                  ...
                  style={{ color: "#C9933A", fontSize: "1.1rem" }}
                ></i>
              </div>
              <span
                style={{
            ...
            >
              Where cakes transform into edible masterpieces and every
              celebration finds its perfect sweet expression.
            </p>
            <div className="d-flex gap-2 mt-3">
              <a
                href="https://www.instagram.com/mukilan_vasantharaj/"
                style={{
                  width: 34,
                  height: 34,
              ...
              {[
                ...
                <li key={href}>
                  <a
                    ...
                    onMouseLeave={(e) =>
                      (e.target.style.color = "rgba(250,250,248,0.5)")
                    }
                  >
                    {label}
                  </a>
          ...
          <div className="col-md-4 d-flex flex-column align-items-center text-center">
            ...
            <div className="d-flex flex-column gap-3 align-items-center">
              {[
                {
                  icon: "bi-geo-alt",
                  text: "Main Street, Santhively, Batticaloa",
                },
                ...
                <div key={i} className="d-flex gap-2 align-items-start">
                  ...
                  >
                    <i
                      ...
                      style={{ color: "#C9933A", fontSize: "0.75rem" }}
                    ></i>
                  </div>
                  <span
                    style={{
        ...
        >
          ...
          >
            © 2026 Cube Cake Shop • Made with{" "}
            <i
              className="bi bi-heart-fill"
              style={{ color: "#C4614A", margin: "0 3px" }}
            ></i>{" "}
            and sprinkles
          </p>
        </div>
