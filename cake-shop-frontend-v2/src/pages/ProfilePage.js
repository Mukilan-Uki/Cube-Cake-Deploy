...
const ProfilePage = () => {
  ...
  const profilePic =
    profileForm.profilePicture != null
        ...
        <div className="col-md-3 mb-4">
          <div className="glass-card p-4">
            <div className="text-center mb-4">
              ...
              <span
                className={`badge mt-2 ${user.role === "super_admin" ? "bg-danger" : user.role === "shop_owner" ? "bg-warning text-dark" : "bg-lavender"}`}
              >
            ...
            {activeTab === "profile" && (
              <>
                ...
                <div
                  ...
                  style={{
                    background: "rgba(255,158,109,0.06)",
                    border: "1.5px dashed rgba(255,158,109,0.3)",
                  }}
                >
                  <h6 className="text-chocolate mb-3">
                      ...
                      <div className="d-flex align-items-center gap-3">
                        <div
                          style={{
                            ...
                            flexShrink: 0,
                            background:
                              "linear-gradient(135deg, #FF9E6D, #FF6B8B)",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            fontSize: "1.6rem",
                        ...
                        <div>
                          <p className="mb-1 fw-medium text-chocolate">
                            Profile photo set ✓
                          </p>
                          <button
                            type="button"
                      ...
                      <div className="d-flex align-items-center gap-4">
                        <div
                          style={{
                            ...
                            flexShrink: 0,
                            background:
                              "linear-gradient(135deg, #FF9E6D, #000000ff)",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            fontSize: "1.6rem",
