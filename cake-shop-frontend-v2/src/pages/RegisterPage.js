...
const RegisterPage = () => {
  ...
  const validate = () => {
    ...
    else if (errors.email === "This email is already taken")
      e.email = "This email is already taken";
  ...
  const inputStyle = (hasError) => ({
    ...
    border: `1.5px solid ${hasError ? "rgba(220,53,69,0.5)" : "rgba(255,255,255,0.1)"}`,
    borderRadius: 12,
    color: "white",
    fontSize: "0.9rem",
    outline: "none",
  ...
  if (success)
    return (
      <div
        style={{
          minHeight: "100vh",
          background: "linear-gradient(135deg,#0f0a06,#1a0f08,#2c1810)",
          display: "flex",
          alignItems: "center",
      ...
      >
        <div style={{ textAlign: "center", color: "white" }}>
          ...
          <div
            ...
            style={{ color: "#D4AF37", width: "1.5rem", height: "1.5rem" }}
          ></div>
        </div>
      </div>
    );
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background:
          "linear-gradient(135deg,#0f0a06 0%,#1a0f08 40%,#2c1810 100%)",
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        padding: "2rem",
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "1.75rem" }}>
          ...
          >
            Join Cube Cake and start ordering
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            style={{
              ...
              background: loading
                ? "rgba(212,175,55,0.4)"
                : "linear-gradient(135deg,#D4AF37,#F1D06E)",
              border: "none",
              borderRadius: 12,
              color: "#1a0f08",
              fontWeight: 700,
        ...
        >
          ...
          >
            Want to sell cakes on our platform?
          </p>
          <Link
            to="/register/shop"
            style={{
